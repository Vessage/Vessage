...
enum SMSUIResponseState
{
    ...
    SMSUIResponseStateSelfVerify = 3,
};
 ...
 * @param 返回的好友信息数组
 */
typedef void (^SMSUIVerificationCodeResultHandler)(enum SMSUIResponseState state,NSString *phoneNumber,NSString *zone,NSString *code, NSError *error);
