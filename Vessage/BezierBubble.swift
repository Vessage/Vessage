...
func drawBezierRightBubble(_ width:CGFloat,height:CGFloat,startYRatio:CGFloat,bezierPath b:UIBezierPath) -> CGPoint  {
    ...
    b.addArc( withCenter: CGPoint(x: startMarkSize.height+cornerRadius, y: h-cornerRadius), radius: cornerRadius, startAngle: CGFloat(Double.pi), endAngle: CGFloat(Double.pi / 2), clockwise: false)
    b.addArc( withCenter: CGPoint(x: w-cornerRadius, y: h-cornerRadius), radius: cornerRadius, startAngle: CGFloat(Double.pi / 2), endAngle: CGFloat(0), clockwise: false)
    b.addArc( withCenter: CGPoint(x: w-cornerRadius, y: cornerRadius), radius: cornerRadius, startAngle: CGFloat(0), endAngle: CGFloat(Double.pi * 3 / 2), clockwise: false)
    b.addArc( withCenter: CGPoint(x: startMarkSize.height+cornerRadius, y: cornerRadius), radius: cornerRadius, startAngle: CGFloat(Double.pi * 3 / 2), endAngle: CGFloat(Double.pi), clockwise: false)
...
func drawBezierLeftBubble(_ width:CGFloat,height:CGFloat,startYRatio:CGFloat,bezierPath b:UIBezierPath) -> CGPoint {
    ...
    b.addArc( withCenter: CGPoint(x: w-startMarkSize.height-cornerRadius, y: cornerRadius), radius: cornerRadius, startAngle: CGFloat(0), endAngle: CGFloat(Double.pi * 3 / 2), clockwise: false)
    b.addArc( withCenter: CGPoint(x: cornerRadius, y: cornerRadius), radius: cornerRadius, startAngle: CGFloat(Double.pi * 3 / 2), endAngle: CGFloat(Double.pi), clockwise: false)
    b.addArc( withCenter: CGPoint(x: cornerRadius, y: h-cornerRadius), radius: cornerRadius, startAngle: CGFloat(Double.pi), endAngle: CGFloat(Double.pi / 2), clockwise: false)
    
    b.addArc( withCenter: CGPoint(x: w-startMarkSize.height-cornerRadius, y: h-cornerRadius), radius: cornerRadius, startAngle: CGFloat(Double.pi / 2), endAngle: CGFloat(0), clockwise: false)
...
func drawBezierUpBubble(_ width:CGFloat,height:CGFloat,startXRatio:CGFloat,bezierPath b:UIBezierPath) -> CGPoint  {
    ...
    b.addArc( withCenter: CGPoint(x: cornerRadius, y: startMarkSize.height + cornerRadius), radius: cornerRadius, startAngle: CGFloat(Double.pi*3/2), endAngle: CGFloat(Double.pi), clockwise: false)
    b.addArc( withCenter: CGPoint(x: cornerRadius, y: h-cornerRadius), radius: cornerRadius, startAngle: CGFloat(Double.pi), endAngle: CGFloat(Double.pi / 2), clockwise: false)
    b.addArc( withCenter: CGPoint(x: w-cornerRadius, y: h-cornerRadius), radius: cornerRadius, startAngle: CGFloat(Double.pi / 2), endAngle: CGFloat(0), clockwise: false)
    b.addArc( withCenter: CGPoint(x: w-cornerRadius, y: startMarkSize.height + cornerRadius), radius: cornerRadius, startAngle: CGFloat(0), endAngle: CGFloat(Double.pi * 3 / 2), clockwise: false)
...
func drawBezierDownBubble(_ width:CGFloat,height:CGFloat,startXRatio:CGFloat,bezierPath b:UIBezierPath) -> CGPoint {
    ...
    b.addArc( withCenter: CGPoint(x: w-cornerRadius, y: h-startMarkSize.height-cornerRadius), radius: cornerRadius, startAngle: CGFloat(Double.pi / 2), endAngle: CGFloat(0), clockwise: false)
    b.addArc( withCenter: CGPoint(x: w-cornerRadius, y: cornerRadius), radius: cornerRadius, startAngle: CGFloat(0), endAngle: CGFloat(Double.pi * 3 / 2), clockwise: false)
    b.addArc( withCenter: CGPoint(x: cornerRadius, y: cornerRadius), radius: cornerRadius, startAngle: CGFloat(Double.pi * 3 / 2), endAngle: CGFloat(Double.pi), clockwise: false)
    b.addArc( withCenter: CGPoint(x: cornerRadius, y: h - startMarkSize.height-cornerRadius), radius: cornerRadius, startAngle: CGFloat(Double.pi), endAngle: CGFloat(Double.pi / 2), clockwise: false)
