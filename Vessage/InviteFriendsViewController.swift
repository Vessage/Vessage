...
class InviteFriendsViewController: UIViewController {
    ...
    @IBAction func inviteButtonClick(sender: AnyObject) {
        ShareHelper.instance.showTellVegeToFriendsAlert(self,message: "TELL_FRIEND_MESSAGE".localizedString(),alertMsg: "TELL_FRIENDS_ALERT_MSG_IV".localizedString(),title: "TELL_FRIENDS_IV".localizedString())
    }
